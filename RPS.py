...
#NEXT STEP CREATE A CLASS for RPS (DONE)
...
#Win outcome (Rock vs scissor; paper vs rock; scissor vs paper)
    elif (guess == "rock" and answer == "scissor") or (guess == "paper" and answer == "rock") or (guess == "scissor" and answer == "paper"):   
        print ("You win \nThe computer chose:", answer)       
    
#Lose outcome (Rock vs paper; paper vs scissor; scissor vs rock)
